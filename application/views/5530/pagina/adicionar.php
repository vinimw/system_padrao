	...
	<div class="alinhaCem">
		<div class="col-one">
			...
			<?php 
				...
				echo form_open('wbadmin/pagina/add/', $attributes); 

			?>
				<div class="alinhaCem">
					<div class="uncol-two">
						<label class="form-label">Nome da página: <span class="label-required">*</span></label>
						<input class="form-input-two required" type="text" name="page_titulo" placeholder="Digite o nome da página">
					</div>

					<div class="uncol-two">
						<label class="form-label">Ordem da página: <span class="label-required">*</span></label>
						<input class="form-input-two required" type="text" name="page_ordem" >
					</div>
				</div>
				...
				<div class="alinhaCem">
					...
					<div class="uncol-two">
						...
						<input class="form-input-two" type="text" name="page_linkfora" >
					</div>
				...
				<div class="alinhaCem">
							<div class="uncol-one">
								...
								<div class="alinhaCem">
								 	<textarea class="" name="page_html" id="noticia"></textarea>
								</div>
							</div>
						</div>
