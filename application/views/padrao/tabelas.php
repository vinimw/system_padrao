<div class="enquadraAlinhascroll">
			...
			<div class="alinhaCem">
				<div class="col-one">
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table-list"  width="100%">
		<thead>
			<tr>
		...
		<tbody>
			...
			<tr>
				...
				<td align="center"><a href="#" class="icon-edit"><img src="<?php echo base_url('assets/images/edit.png');?>"></a><a href="#" class="icon-delete"><img src="<?php echo base_url('assets/images/delete.png');?>"></a><a href="#" class="icon-edit"><img src="<?php echo base_url('assets/images/ok.png');?>"></a></td>
			</tr>
			...
			<tr>
				...
				<td align="center"><a href="#" class="icon-edit"><img src="<?php echo base_url('assets/images/edit.png');?>"></a><a href="#" class="icon-delete"><img src="<?php echo base_url('assets/images/delete.png');?>"></a></td>
			</tr>
